                ...
                <div class="ui-block-a">
                	<div class="ui-body ui-body-d">
                        ...
                        <div class="haft border"> 
							...
							<div class="haft">
                                    <a href="#" onclick="increase('shirt')" class="ui-icon-alt" data-role="button" data-icon="plus" data-iconpos="notext" data-inline="true">Plus</a>
                                    <a href="#" onclick="decrease('shirt')" class="ui-icon-alt" data-role="button" data-icon="minus" data-iconpos="notext" data-inline="true">Minus</a>
                                </div>
							<div class="haft">
								<input type="number" name="shirt" id="shirt" value="" >
							</div>
                        ...
                        <div class="haft border">
                            <div><img src="images/02.png"/>                            
                                <div class="haft">
                                    <a href="#" onclick="increase('trouser')" class="ui-icon-alt" data-role="button" data-icon="plus" data-iconpos="notext" data-inline="true">Plus</a>
                                    <a href="#" onclick="decrease('trouser')" class="ui-icon-alt" data-role="button" data-icon="minus" data-iconpos="notext" data-inline="true">Minus</a>
                                </div>
                                <div class="haft">
                                   <input type="number"  name="trouser" id="trouser" value="0" >
                                </div>                    	
                            </div>
